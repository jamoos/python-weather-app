...
@app.route("/")
def home():
    cities = ["Tel-Aviv", "Haifa", "Jerusalem", "New-York", "London", "Paris", "Bangkok", "San Francisco"]
...
@metrics.counter('invoication_by_location', 'Number of invocations per location', labels={'location':lambda: request.view_args['location']})
